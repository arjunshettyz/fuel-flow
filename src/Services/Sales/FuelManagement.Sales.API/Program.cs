...
{
    opts.UseSqlServer(builder.Configuration.GetConnectionString("SalesDb"));
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Fuel sales transaction recording, pump management, and payment processing."
    });
...
app.UseSwaggerUI(c =>
{
    ...
    c.DocumentTitle = "Sales Service — Fuel Management";
});
