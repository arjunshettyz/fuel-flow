...
{
    opts.UseSqlServer(builder.Configuration.GetConnectionString("ReportingDb"));
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Reporting Service API", Version = "v1",
        Description = "Analytics, scheduled reports, and PDF/Excel export for the Indian Fuel Management System."
    });
...
app.UseSwaggerUI(c =>
{
    ...
    c.DocumentTitle = "Reporting Service — Fuel Management";
});
